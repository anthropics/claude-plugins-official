...
description: File-based context patterns for agents. Use when organizing documentation into folders, offloading large tool outputs to files, creating scratch pads for intermediate results, writing research outputs to docs/, managing plan files, or coordinating between sub-agents via filesystem.
---
