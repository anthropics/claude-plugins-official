...
description: Structured summarization techniques for long sessions. Use when summarizing session history, writing CHANGELOG entries, creating wrap-up documentation, compressing conversation context, updating CLAUDE.md with session state, or handling context window limits during long-running tasks.
---
